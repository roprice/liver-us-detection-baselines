"""Overlap detection (IoU > 0.2) vs. training size for the data-scaling experiment.
...
Run from the project root:
    python analysis/data_scaling/evaluate_overlap_detection/evaluate_overlap_detection_iou_02.py
"""
...
OUT_BASE = "evaluate_overlap_detection_iou_02"
