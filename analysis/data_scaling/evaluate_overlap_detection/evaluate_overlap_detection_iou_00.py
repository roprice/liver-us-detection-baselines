"""Overlap detection (IoU > 0) vs. training size for the data-scaling experiment.
...
Run from the project root:
    python analysis/data_scaling/evaluate_overlap_detection/evaluate_overlap_detection_iou_00.py
"""
...
IOU_THRESHOLD = 0.0
FLAG_FIELD = "overlap_detection_iou_00_flag"
OUT_BASE = "evaluate_overlap_detection_iou_00"
