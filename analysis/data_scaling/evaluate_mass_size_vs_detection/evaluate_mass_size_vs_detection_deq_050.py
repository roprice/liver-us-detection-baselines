"""Case-level centroid detection by training size and ground-truth mass area.
...
Run from the project root:
    python analysis/data_scaling/evaluate_mass_size_vs_detection/evaluate_mass_size_vs_detection_deq_050.py
"""
...
OUT_BASE = "evaluate_mass_size_vs_detection_deq_050"
DEQ_FACTOR = 0.5
TITLE = f"Case-level centroid-based detection (deq={DEQ_FACTOR:g}) by training size and mass size"
DEFINITION = (
    ...
    "(D = 2 × sqrt(area / π)). This is scale-relative, not a physical distance."
)
DEFINITION_METADATA = {
    "centroid_definition": f"predicted centroid within {DEQ_FACTOR:g}x GT equivalent diameter",
    "deq_factor": DEQ_FACTOR,
}
DETECTION_LABEL = "Centroid Detection"
Y_LABEL = "Combined centroid recall"
