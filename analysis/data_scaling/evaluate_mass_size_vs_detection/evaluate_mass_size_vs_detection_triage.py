"""Case-level triage detection by training size and ground-truth mass area.
...
Run from the project root:
    python analysis/data_scaling/evaluate_mass_size_vs_detection/evaluate_mass_size_vs_detection_triage.py
"""
...
FLAG_FIELD = "triage_detection_flag"
NORMAL_FLAG_FIELD = "triage_detection_flag"
OUT_BASE = "evaluate_mass_size_vs_detection_triage"
TITLE = "Case-level triage-based detection by training size and mass size"
DEFINITION = (
    "A mass-present case is detected if the model predicts any retained mass "
    "anywhere on the image. No overlap or localization is required; "
    "an IoU threshold does not apply."
)
DEFINITION_METADATA = {"triage_definition": "any retained mass (no overlap required)"}
DETECTION_LABEL = "Triage Detection"
Y_LABEL = "Combined triage recall"
