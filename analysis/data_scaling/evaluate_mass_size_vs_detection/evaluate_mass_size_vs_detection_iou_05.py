"""Case-level overlap detection (IoU > 0.5) by training size and mass area.
...
Run from the project root:
    python analysis/data_scaling/evaluate_mass_size_vs_detection/evaluate_mass_size_vs_detection_iou_05.py
"""
...
OUT_BASE = "evaluate_mass_size_vs_detection_iou_05"
IOU_THRESHOLD = 0.5
