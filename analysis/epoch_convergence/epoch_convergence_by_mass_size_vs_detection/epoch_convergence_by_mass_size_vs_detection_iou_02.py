"""Overlap detection (IoU > 0.2) vs. epoch, broken down by mass size, for the
...
between a retained predicted component and the ground-truth mass exceeds 0.2.
...
than the raw masks; overlap_detection_iou_02_flag, normal_false_positive,
...
Run from project root:
    python analysis/epoch_convergence/epoch_convergence_by_mass_size_vs_detection/epoch_convergence_by_mass_size_vs_detection_iou_02.py
"""
...
OUT_BASE = "epoch_convergence_by_mass_size_vs_detection_iou_02"
...
def evaluate_epoch_bin(rows, positive_class, low, high=None):
    """Run overlap (IoU > 0.2) eval for one checkpoint and bin; return recall and FP rate."""
...
def main():
    ...
    md_lines = [
        ...
        f"detection = IoU > 0.2, noise floor {NOISE_FLOOR}.",
        "",
