...
component is detected when that predicted centroid lies within 0.25x the
...
than the raw masks; centroid_detection_deq_025_flag and pathology come from there.

Three seeds (42/43/44), 625 images each; error bars are the across-seed std.

Run from project root:
    python analysis/epoch_convergence/epoch_convergence_by_centroid_detection/epoch_convergence_by_centroid_detection_deq_025.py
"""
