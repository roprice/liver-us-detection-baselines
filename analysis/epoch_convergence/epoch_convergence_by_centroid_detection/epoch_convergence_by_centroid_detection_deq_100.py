...
component is detected when that predicted centroid lies within 1.0x the
...
than the raw masks; centroid_detection_deq_100_flag and pathology come from there.

Single-seed run (seed 42, 625 images); no error bars.

Run from project root:
    python analysis/epoch_convergence/epoch_convergence_by_centroid_detection/epoch_convergence_by_centroid_detection_deq_100.py
"""
...
DEQ_FACTOR = 1.0
FLAG_FIELD = "centroid_detection_deq_100_flag"
OUT_BASE = "epoch_convergence_by_centroid_detection_deq_100"
